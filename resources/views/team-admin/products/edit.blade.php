...
<div class="min-h-screen bg-emerald-50">
    ...
    <div class="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <p class="mt-2 text-emerald-50">Update product information</p>
        </div>
    </div>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('team-admin.products') }}" class="inline-flex items-center text-emerald-700 hover:text-emerald-600 transition-colors font-medium">
        ...
        <!-- Form Card -->
        <div class="bg-white rounded-2xl shadow-lg p-8 border-l-8 border-teal-500">
            <form action="{{ route('team-admin.products.update', $product) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6 p-4 bg-emerald-50 rounded-lg border border-emerald-200">
                    <h3 class="text-sm font-medium text-emerald-800 mb-2">Product Information</h3>
                ...
                <div class="flex gap-4">
                    ...
                    <a 
                        href="{{ route('team-admin.products') }}" 
